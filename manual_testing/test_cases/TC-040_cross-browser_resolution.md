...
**Предусловия:**  
Выполнен поиск по запросу "тестирование". Открыта страница результатов поиска в браузере Firefox. Разрешение установлено 768x1024.  
...
* **Негативная проверка:** Проверить поведение интерфейса при масштабировании страницы.  

---

#### TC-044-3: Отображение результатов поиска на планшете (768x1024) в Safari  

**ID:** TC-044-3  
**Название:** Проверка отображения результатов поиска на планшете (768x1024) в Safari  

**Предусловия:**  
Выполнен поиск по запросу "тестирование". Открыта страница результатов поиска в браузере Safari. Разрешение установлено 768x1024.  

**Проверка:**  
* Проверить корректность отображения результатов поиска на планшете.  
* Убедиться, что элементы интерфейса отображаются корректно, а текст читаем.  
* Проверить, что интерфейс адаптируется при изменении масштаба или ориентации экрана.  
* **Негативная проверка:** Проверить отображение при медленном соединении и поведении элементов интерфейса при масштабировании страницы.  
...
* **Негативная проверка:** Проверить корректность отображения при изменении масштаба страницы (Cmd +/Cmd -).
...
* **Негативная проверка:** Проверить, что элементы интерфейса не перекрываются и текст остается читаемым при изменении ориентации экрана.  
...
* **Негативная проверка:** Проверить корректность отображения при масштабировании страницы.  
